...
- **Unmerged feature branches:** 23 already-merged branches were pruned during this cleanup; **4 remain** (`chore/summary-and-demo-notes`, `feat/body-of-christ-rebrand`, `feat/issue-64-similar-needs-on-confirmation`, `flyio-new-files`) — some may be superseded by items already checked off in `BACKLOG.md`; triage before resuming.
